...
# 取值有收据：见 docs/P5.3-检索backlink重排.md §4.5（三真实库 × 三探针 × n=1720 扩样扫描）。
# 首版 0.5 是未经测量的直觉值、实测为净回退（微平均 P@1 .784→.699），2026-09-13 下调至 0.05。
# 再动此值须重跑 §4.5 的扫描并更新那张表。
BACKLINK_WEIGHT = 0.05
