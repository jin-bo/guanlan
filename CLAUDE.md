...
**Current status:** released through v0.1.12. Implemented = P2 minimal closed loop + P3 health/graph family + P4 optional host layer (Web + MCP) + P5 retrieval/multi-format ingest, including every half-phase P2.1–P5.4; no roadmap spec remains unimplemented.
