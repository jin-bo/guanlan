...
uv run pytest tests/test_agentao_contract.py  # P4.23 agentao seam contracts — the only tests on a *real* Agentao (offline: dead LLM endpoint); the rest fake the factory and can't see upstream behavior
